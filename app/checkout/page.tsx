  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        {plans.map((plan, index) => (
          <Card
            ...
            className={`p-6 cursor-pointer transition-all ${
              selectedPlan === index ? 'border-primary shadow-lg' : 'hover:border-primary/50'
            }`}
          ...
          >
            ...
            <Button className="w-full" variant={selectedPlan === index ? 'default' : 'outline'}>
              Seleziona
            </Button>
          </Card>
        ))}
      ...
      <div className="mt-8 text-center">
        <Button size="lg" onClick={handleCheckout} disabled={loading || selectedPlan === null}>
          {loading ? (
            <>
